        ...
        <div class="container">
            <div class="row">
                <section class="content_full">
                    <div class="block">
                        <h3 class="mb-3 mt-3 text-center">Все статьи</h3>
                        <div class="block_content">
                            ...
                            <?php
                                if ($articles_exit == true) {
                                    ...
                                    if ($page > 1) {
                                        echo '<a style="padding: 10px;" href="/articles.php?page='.($page - 1).'">&laquo; Назад </a>';
                                    }
                                    if ($page < $total_pages) {
                                        echo '<a style="padding: 10px;" href="/articles.php?page='.($page + 1).'">Вперёд &raquo </a>';
                                    }
                                    echo '</div>';
                                }
                            ?>
